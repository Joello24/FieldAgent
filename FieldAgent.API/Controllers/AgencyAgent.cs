...
public class AgencyAgentController : ControllerBase
{
    private readonly IAgencyAgentRepository _agencyAgentRepository;

    public AgencyAgentController(IAgentRepository agentRepository)
    {
